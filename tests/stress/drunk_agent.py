...
_PROFILES: dict[str, DrunkAgentProfile] = {
    "fast_coder": DrunkAgentProfile(
        ...
        ttft_sigma=0.3,         # CV ≈ 30%, p95 ≈ 200ms
    ...
    "unstable": DrunkAgentProfile(
        ...
        ttft_sigma=0.4,         # CV ≈ 40%, p95 ≈ 430ms (higher variance than fast_coder)
        write_mean_secs=0.3,
        stall_prob=0.15,
    ...
    "overthinker": DrunkAgentProfile(
        ...
        ttft_sigma=0.6,         # CV ≈ 60%, p95 ≈ 6s (largest, justified by extreme workload)
        write_mean_secs=3.0,
        stall_prob=0.50,
    ...
    "balanced": DrunkAgentProfile(
        ...
        ttft_mu=-1.51,          # ln(0.22) → p50 ≈ 220 ms
        ttft_sigma=0.35,        # CV ≈ 35%, p95 ≈ 360ms
        write_mean_secs=0.3,
        stall_prob=0.10,
